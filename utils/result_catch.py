...
def SL_result_catch(data: dict, varname: str, SL_mode: str):
    """
    result catch interface
    ...
    :param SL_mode: indicating how SL works.
            'load': load catched data into data['SL_content']. False if not catched.
...
def generate_path(data: dict, path_name: str):
    ...
    savepath = f'data/result_catch_files{flag_suffix if flag_suffix else "/"}{arms}arms{conf_suffix}/{loose_lbl}/{label}'
    if varname != 0:
